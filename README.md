...
학습 List: 정보처리기사(SW기초), CS 6대과목(자료구조, 알고리즘, 데이터베이스+SQL, 운영체제, 네트워크, 컴퓨터구조), Java-Spring, HTML, CSS, JS, React, Vue, jQuery-ajax, git-github, linux, Mongo DB, AWS, Docker-Kubernetes
